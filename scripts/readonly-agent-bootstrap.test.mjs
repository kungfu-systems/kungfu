...
function pruneEmptyDirectories(root) {
  for (const entry of fs.readdirSync(root, { withFileTypes: true })) {
    ...
    pruneEmptyDirectories(absolute);
...
function semanticAmplificationFixturePaths(manifest) {
  const paths = new Set([
    ...
    'developer/maintainability/semantic-amplification.manifest.json',
    'developer/maintainability/semantic-amplification.mjs',
    'developer/maintainability/terminal-evidence-matrix.json',
  ]);
...
function workProfileConformanceFixturePaths(manifest) {
  const paths = new Set([
    ...
    'framework/work/work-profile-conformance/authority-manifest.json',
    'framework/work/work-profile-conformance/generate-qualification.mjs',
    ...
    'framework/work/work-profile-conformance/schema/work-profile-conformance-declaration-v1.schema.json',
    'framework/work/work-profile-conformance/schema/work-profile-conformance-result-v1.schema.json',
...
test('declared discovery routes are zero-write in a cold read-only fixture', (t) => {
  ...
  for (const relative of [
    ...
    'product/release/kungfu-release-provenance.contract.json',
    ...
    'product/release/kfd-adopter-release.mjs',
    'product/release/kfd-candidate-evidence.mjs',
    ...
    'product/release/kungfu-ungfu-release-evidence.candidate.json',
    'product/release/kungfu-ungfu-release-evidence.schema.json',
    ...
    'product/version-line/check-version-line-authority.mjs',
    'product/version-line/version-line-authority.json',
    'product/version-line/version-line-authority.mjs',
    ...
    'framework/spec/incubation/incubation-passport.baseline.json',
    ...
    'developer/production-graph/compiler/index.mjs',
    'developer/production-graph/feedback/index.mjs',
    'developer/production-graph/executor/index.mjs',
    'developer/production-graph/executor/index.test.mjs',
    'developer/production-graph/result-projection/index.mjs',
    'developer/production-graph/result-projection/index.test.mjs',
    'developer/production-graph/compiler/polyglot.fixture.mjs',
    'developer/production-graph/contract.mjs',
    'developer/production-graph/core-subgraph/index.mjs',
    'developer/production-graph/core-subgraph/index.test.mjs',
    ...
    'pnpm-lock.yaml',
    'product/release/buildchain-kfd-runtime.mjs',
    ...
    'developer/maintainability/baseline-transitions/README.md',
    'developer/maintainability/code-complexity-policy.json',
    'developer/maintainability/code-complexity-baseline.json',
    'developer/maintainability/waivers/retired/hub-cli-linux-arm64-dist-platform-map.v1.json',
    'developer/maintainability/waivers/retired/hub-cli-linux-arm64-post-queue-workflow-authority.v1.json',
    'developer/maintainability/waivers/retired/hub-cli-linux-arm64-workflow-authority.v1.json',
    'developer/maintainability/waivers/retired/libnode-linux-arm64-lockfile.v1.json',
    'developer/maintainability/complexity-governance.mjs',
    'developer/maintainability/abstraction-integrity.manifest.json',
    'developer/maintainability/abstraction-integrity.baseline.json',
    'developer/maintainability/abstraction-integrity-report.json',
    'developer/report-projection/authority.json',
    'developer/maintainability/python-structure-negative-fixtures.json',
    'developer/maintainability/readonly-source-routes.json',
    'developer/maintainability/semantic-amplification.manifest.json',
    'developer/maintainability/semantic-amplification-report.json',
    'developer/maintainability/semantic-amplification.mjs',
    'developer/maintainability/semantic-amplification.test.mjs',
    'developer/report-projection/authority.mjs',
    ...
    'developer/maintainability/waivers/README.md',
    'framework/work/work-history-selector/schema/work-history-selection-manifest-v1.schema.json',
    'framework/work/work-history-selector/schema/work-history-selection-request-v1.schema.json',
    'framework/work/work-history-selector/src/work-history-selector.mjs',
    'framework/work/work-history-selector/tooling/check-work-history-selector.mjs',
    'framework/work/work-history-selector/tooling/work-history-selector-contract.mjs',
    'framework/work/work-history-selector/work-history-selector.contract.json',
    'framework/work/work-design-advisor/schema/work-design-advice-request-v1.schema.json',
    'framework/work/work-design-advisor/schema/work-design-advice-v1.schema.json',
    'framework/work/work-design-advisor/schema/work-design-advice-verification-v1.schema.json',
    'framework/work/work-design-advisor/schema/work-design-disposition-v1.schema.json',
    'framework/work/work-design-advisor/src/work-design-advisor.mjs',
    'framework/work/work-design-advisor/tooling/check-work-design-advisor.mjs',
    'framework/work/work-design-advisor/tooling/work-design-advisor-contract.mjs',
    'framework/work/work-design-advisor/work-design-advisor.contract.json',
    'framework/work/work-design-policy-replay/schema/work-design-promotion-artifact-v1.schema.json',
    'framework/work/work-design-policy-replay/schema/work-design-activation-envelope-v1.schema.json',
    'framework/work/work-design-policy-replay/schema/work-design-feedback-inspection-v1.schema.json',
    'framework/work/work-design-policy-replay/schema/work-design-feedback-status-v1.schema.json',
    'framework/work/work-design-policy-replay/schema/work-design-outcome-compilation-request-v1.schema.json',
    'framework/work/work-design-policy-replay/schema/work-design-outcome-v1.schema.json',
    'framework/work/work-design-policy-replay/schema/work-design-policy-decision-v1.schema.json',
    'framework/work/work-design-policy-replay/schema/work-design-policy-monitoring-v1.schema.json',
    'framework/work/work-design-policy-replay/schema/work-design-policy-state-v1.schema.json',
    'framework/work/work-design-policy-replay/schema/work-design-replay-policy-v1.schema.json',
    'framework/work/work-design-policy-replay/schema/work-design-replay-report-v1.schema.json',
    'framework/work/work-design-policy-replay/schema/work-design-replay-request-v1.schema.json',
    'framework/work/work-design-policy-replay/src/work-design-policy-replay.mjs',
    'framework/work/work-design-policy-replay/tooling/check-work-design-policy-replay.mjs',
    'framework/work/work-design-policy-replay/tooling/work-design-policy-replay-contract.mjs',
    'framework/work/work-design-policy-replay/work-design-policy-replay.contract.json',
    'framework/work/work-design-preflight/src/work-design-preflight.mjs',
    ...
    'framework/work/work-design-preflight/work-design-preflight.contract.json',
  ])
