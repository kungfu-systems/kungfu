...
test('Dev auto-merge admits only explicitly ready reviewed same-repository PRs', () => {
  ...
  assert.equal(reusableRef, 'a12442567126cb55790263f86777d81263425273');
...
test('Dev behind admission produces and forwards an exact Project Cut replay proof', () => {
  ...
  assert.match(
    workflow,
    /Check out exact Buildchain delivery runtime[\s\S]*ref: a12442567126cb55790263f86777d81263425273/u,
  );
  assert.match(
    workflow,
