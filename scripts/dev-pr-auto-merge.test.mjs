...
test('Dev auto-merge admits only explicitly ready reviewed same-repository PRs', () => {
  ...
  assert.equal(reusableRef, '1ecd150402c6e08f7bd9d4f840c808521bc3a9d1');
...
test('Dev behind admission produces and forwards an exact Project Cut replay proof', () => {
  ...
  assert.match(
    workflow,
    /Check out exact Buildchain delivery runtime[\s\S]*ref: 1ecd150402c6e08f7bd9d4f840c808521bc3a9d1/u,
  );
  assert.match(
    workflow,
