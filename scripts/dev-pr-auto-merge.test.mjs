...
test('Dev auto-merge admits only explicitly ready reviewed same-repository PRs', () => {
  ...
  assert.equal(reusableRef, 'd11b0f15a03a4098147984391c2c6b74f0fd8f92');
...
test('Dev behind admission produces and forwards an exact Project Cut replay proof', () => {
  ...
  assert.match(
    workflow,
    /Check out exact Buildchain delivery runtime[\s\S]*ref: d11b0f15a03a4098147984391c2c6b74f0fd8f92/u,
  );
  assert.match(
    workflow,
