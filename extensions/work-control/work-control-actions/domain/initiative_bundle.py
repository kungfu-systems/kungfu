...
"""Portable native Initiative closure."""
...
def build_initiative_bundle(
    ...
    *,
    ...
    """Build a bounded native Initiative closure from proving Episodes."""
...
def import_initiative_bundle(
    ...
    *,
    ...
    status = "imported" if accepted else "validated" if not execute else "degraded"
    return {
...
def import_initiative_bundle_file(
    ...
    *,
    ...
    return import_initiative_bundle(runtime_dir, bundle, execute=execute)
