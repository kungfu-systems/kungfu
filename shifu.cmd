...
if /i "%~1"=="kfd" if /i "%~2"=="status" goto readonlynode & if /i "%~1"=="kfd" if /i "%~2"=="query" goto readonlynode & if /i "%~1"=="kfd" if /i "%~2"=="check" goto readonlynode & if /i "%~1"=="kfd:query" goto readonlynode & if /i "%~1"=="kfd:support-matrix:check" goto readonlynode & if /i "%~1"=="maintainability:query" goto readonlynode & if /i "%~1"=="work-design:open-card-preflight" goto readonlynode
