...
function verifierRoot() {
  return semanticRoot(
    [
      ...
      'developer/production-graph/shadow-build-core/index.mjs',
      'developer/production-graph/shadow-build-core/index.test.mjs',
      'developer/production-graph/result-projection/index.mjs',
      'developer/production-graph/result-projection/index.test.mjs',
      'developer/production-graph/local-ci-parity/index.mjs',
      'developer/production-graph/local-ci-parity/index.test.mjs',
