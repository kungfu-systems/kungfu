...
const POLICY_PATH = 'developer/maintainability/function-risk-policy.json';
...
function buildReport(options = {}) {
  ...
  const identity = {
    ...
    implementationRoot: digest([
      {
        path: 'developer/maintainability/source-analysis-kernel.mjs',
        root: digest(
          currentBytes('developer/maintainability/source-analysis-kernel.mjs'),
        ),
      },
      {
        path: 'developer/maintainability/source-analysis-session.mjs',
        root: digest(
          currentBytes('developer/maintainability/source-analysis-session.mjs'),
        ),
      },
      {
        path: 'developer/maintainability/function-risk.mjs',
        root: digest(
          currentBytes('developer/maintainability/function-risk.mjs'),
        ),
      },
      {
        path: 'developer/maintainability/function-risk-transition.mjs',
        root: digest(
          currentBytes(
