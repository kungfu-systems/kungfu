...
const MATRIX_PATH = 'developer/maintainability/terminal-evidence-matrix.json';
const SHA = /^[0-9a-f]{40}$/u;
const ROOT_PATTERN = /^sha256:[0-9a-f]{64}$/u;
const EXECUTABLE_INPUTS = [
  MATRIX_PATH,
  'developer/maintainability/terminal-evidence.mjs',
  'framework/work/terminal-evidence/live-observations.mjs',
  'framework/work/terminal-evidence/live-verification.mjs',
  'framework/work/terminal-evidence/verification-primitives.mjs',
];
