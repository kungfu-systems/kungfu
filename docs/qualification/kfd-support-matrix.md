...
| KFD-5 | active r7 | candidate | partial | blocked-product-qualification | failed | not-qualified | no | Complete and retain one product-specific primitive genesis, falsification, dogfood, and acceptance cut. |
...
- KFD-3 uses Buildchain's product-declared registry audit directly. It currently has 169 declared surfaces and 0 release-Gate-enforced surfaces. Declaration is discoverability; it is not enforcement.
