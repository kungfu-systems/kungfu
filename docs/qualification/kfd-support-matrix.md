...
- KFD-3 uses Buildchain's product-declared registry audit directly. It currently has 176 declared surfaces and 0 release-Gate-enforced surfaces. Declaration is discoverability; it is not enforcement.
