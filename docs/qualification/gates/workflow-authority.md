...
| `.github/workflows/affected-native-pr.yml` | `affected_native_shards` | qualification | none | diagnostic | token:read | none | 18 |
...
| `.github/workflows/affected-native-pr.yml` | `kfd_verifier` | qualification | none | diagnostic | token:read | none | 3 |
...
| `.github/workflows/build.yml` | `kfd-candidate-evidence` | qualification | none | qualifying | token:read | none | 3 |
