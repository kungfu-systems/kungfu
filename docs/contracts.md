...
emits the KFD canonical wrapper at `.buildchain/kfd/kfd-2/release-claims.json` and
Buildchain 2.10-compatible raw claim files under `.buildchain/kfd/kfd-2/claims/`.
