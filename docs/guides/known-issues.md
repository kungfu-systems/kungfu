...
1. Search this page and open Issues before creating a report.
2. Keep the earliest complete, reproducible report as the canonical issue unless
   a maintainer records a reason to choose another.
3. Add a link from each duplicate to the canonical issue and preserve genuinely
   new sanitized evidence.
4. Only a human maintainer closes or reopens a duplicate.
5. Update this page when a known blocker, workaround, affected version, or
   proven fixed version changes.

Questions, usage help, ideas, and showcases are not duplicates of bugs merely
because they mention the same feature; route them to Discussions.
