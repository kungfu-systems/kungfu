...
(see [`event-model.md`](../architecture/event-model.md)), most "kungfu is broken" questions reduce
...
[`contracts.md`](../qualification/contracts.md)), a misbehavior recorded in an Episode can be
...
[`known-limits.md`](../qualification/known-limits.md) and the `provenance` row in
[`MAP.md`](../MAP.md).
