...
release-channel matrix also remains staged. Check [known limits](../qualification/known-limits.md)
...
- [Documentation Guide](README.md) routes each reader to the shortest useful
  ...
  evidence.
- [Product Layers](../concepts/product-layers.md) defines each
  product closure and its deletion/qualification tests.
- [Architecture](../architecture/overview.md) explains how the source tree and runtime are
  layered.
- [Known limits](../qualification/known-limits.md) separates current guarantees from staged
  work.
