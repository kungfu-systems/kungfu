...
| `work.lifecycle.work.inspect/v1` | work | inspect | native-work-journal | **unavailable** | missing: kf_runtime_action_api_v1 | cpp=projected<br>python=projected<br>node=projected<br>rust=projected |
| `work.lifecycle.work.create/v1` | work | create | native-work-journal | **unavailable** | missing: kf_runtime_action_api_v1 | cpp=projected<br>python=projected<br>node=projected<br>rust=projected |
| `work.lifecycle.work.update/v1` | work | update | native-work-journal | **unavailable** | missing: kf_runtime_action_api_v1 | cpp=projected<br>python=projected<br>node=projected<br>rust=projected |
| `work.lifecycle.work.transition/v1` | work | transition | native-work-journal | **unavailable** | missing: kf_runtime_action_api_v1 | cpp=projected<br>python=projected<br>node=projected<br>rust=projected |
| `work.lifecycle.work.export/v1` | work | export | native-work-journal | **unavailable** | missing: kf_runtime_action_api_v1 | cpp=projected<br>python=projected<br>node=projected<br>rust=projected |
| `work.lifecycle.work.import/v1` | work | import | native-work-journal | **unavailable** | missing: kf_runtime_action_api_v1 | cpp=projected<br>python=projected<br>node=projected<br>rust=projected |
