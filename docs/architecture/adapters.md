...
serialization (see [`event-model.md`](event-model.md), [`contracts.md`](../qualification/contracts.md)).
...
`peer` (see [`concepts.md`](../concepts/implementation-concepts.md)). N-API is used as the stability
...
- any export out of the system (for example `kungfu storage export --scope
  ...
  [`debugging.md`](../guides/debugging.md)) is an explicit, non-zero-copy conversion.
