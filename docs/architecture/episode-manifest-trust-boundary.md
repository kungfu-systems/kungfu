...
This document is the [KF-ADR-019f86da-4f90-737e-893f-c095b9a05cae](../adr/KF-ADR-019f86da-4f90-737e-893f-c095b9a05cae.md) stage gate artifact. It proves the existing
[KF-ADR-019f86da-4f90-762d-a677-5e8984cc6692](../adr/KF-ADR-019f86da-4f90-762d-a677-5e8984cc6692.md) v1 record family can express every trust-boundary claim [KF-ADR-019f86da-4f90-791c-9b90-4888cca36327](../adr/KF-ADR-019f86da-4f90-791c-9b90-4888cca36327.md)
...
## 1. Field-to-claim map ([KF-ADR-019f86da-4f90-762d-a677-5e8984cc6692](../adr/KF-ADR-019f86da-4f90-762d-a677-5e8984cc6692.md) v1 records → [KF-ADR-019f86da-4f90-791c-9b90-4888cca36327](../adr/KF-ADR-019f86da-4f90-791c-9b90-4888cca36327.md)/0041 claims)
...
Mapping each [KF-ADR-019f86da-4f90-791c-9b90-4888cca36327](../adr/KF-ADR-019f86da-4f90-791c-9b90-4888cca36327.md) trust-boundary claim onto that record set:
...
| causal closure ([KF-ADR-019f86da-4f90-791c-9b90-4888cca36327](../adr/KF-ADR-019f86da-4f90-791c-9b90-4888cca36327.md) core invariant) | derivable: `EpisodeFrameAttached.trigger_frame_uid` edges must resolve inside the Episode's frame set or be declared as `InputFrame` refs / Episode dependencies. Closure is a checked property of the fold, not a stored field | representable (checked, not stored) |
| rebuildable projection / query indexes | not stored in the manifest by design — projections are derived from the journal and verified against it ([KF-ADR-019f86da-4f90-737e-893f-c095b9a05cae](../adr/KF-ADR-019f86da-4f90-737e-893f-c095b9a05cae.md) point 5) | n/a (satisfied structurally) |
| hash roots / sync roots for fsck/export/import | **delivered by [KF-ADR-019f86da-4f90-73f2-a0ac-42f14e0278d9](../adr/KF-ADR-019f86da-4f90-73f2-a0ac-42f14e0278d9.md)**: `EpisodeRootCommitted` (carrier `10806`, additive) records the sealed Episode's content root — a linear chain over the owned claim sequence — appended by the seal path as the final claim. fsck recomputes and verifies it; inspect exposes recorded/computed/match; absence (pre-KF-ADR-019f86da-4f90-73f2-a0ac-42f14e0278d9 data, or a crash between seal and root append) is reported honestly, never failed | representable ([KF-ADR-019f86da-4f90-73f2-a0ac-42f14e0278d9](../adr/KF-ADR-019f86da-4f90-73f2-a0ac-42f14e0278d9.md)) |

Conclusion required by [KF-ADR-019f86da-4f90-737e-893f-c095b9a05cae](../adr/KF-ADR-019f86da-4f90-737e-893f-c095b9a05cae.md): the existing record set is sufficient for
every claim this slice needs. The one claim that was not representable in the
original v1 set (Episode hash/sync roots) has since been closed by [KF-ADR-019f86da-4f90-73f2-a0ac-42f14e0278d9](../adr/KF-ADR-019f86da-4f90-73f2-a0ac-42f14e0278d9.md)'s
...
through [KF-ADR-019f86da-4f90-738c-b372-e509976f69ff](../adr/KF-ADR-019f86da-4f90-738c-b372-e509976f69ff.md)'s immutable `content_store` and changed no record layout.
...
- `EpisodeClosed`: each close applies in order; the **last** close wins the
  ...
  append-only tombstone path ([KF-ADR-019f86da-4f90-791c-9b90-4888cca36327](../adr/KF-ADR-019f86da-4f90-791c-9b90-4888cca36327.md)): fsck reports it as
...
- Crash fixtures C1–C6 as journal-state constructions (fixtures write the
  exact pre-crash record sequences; C5 strips the [KF-ADR-019f86da-4f90-7179-a900-c40bdb498910](../adr/KF-ADR-019f86da-4f90-7179-a900-c40bdb498910.md) publication token
...
## 4. Stage gates recap ([KF-ADR-019f86da-4f90-737e-893f-c095b9a05cae](../adr/KF-ADR-019f86da-4f90-737e-893f-c095b9a05cae.md) first delivery)
...
3. **Structural fsck** (delivered) — over the typed fold: seal claims verified
   ...
   fields, recomputed payload/frame checksums ([KF-ADR-019f86da-4f90-7d72-bf9f-1d5913bbb0d5](../adr/KF-ADR-019f86da-4f90-7d72-bf9f-1d5913bbb0d5.md)/0028) — failing a
...
4. **Content resolution** (delivered) — payload refs resolve through the
   [KF-ADR-019f86da-4f90-738c-b372-e509976f69ff](../adr/KF-ADR-019f86da-4f90-738c-b372-e509976f69ff.md) immutable `content_store` by `ref_hash` (verified read, full
