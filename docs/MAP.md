...
| What is Xinfa, how do projects compile one drift-aware authority into dual-first human/Agent routes, and how is the standalone boundary proved? | [`../xinfa/`](../xinfa/) + [ADR-0092](adr/ADR-0092-xinfa-product-and-incubation-boundary.md) + [ADR-0093](adr/ADR-0093-xinfa-dual-first-verified-context-contract.md) | why, use, verify | incubation · product identity, project/IR schemas, deterministic compiler, drift propagation, route parity, and clean extraction implemented; Pack/Capsule staged |
