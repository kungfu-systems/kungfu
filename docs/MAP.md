...
| Why can Kungfu be understood as a self-bootstrapping system for durable Agent Work, how does that relate to Douglas Engelbart, and what remains unproved? | [`bootstrapping-agent-work.md`](concepts/bootstrapping-agent-work.md) | why | current thesis · implementation, qualification, release, and independent adoption remain distinct |
...
| How do Missions, delegated Go work, runtime facts, proof, independent review, and decisions become one product, and how does authority leave the Atlas bridge? | [`mission-control.md`](profiles/mission-control.md) + [`mission-control-workspaces.md`](profiles/mission-control-workspaces.md) + [KF-ADR-019f86da-4f90-71be-a2aa-c8744fa340d8](./adr/KF-ADR-019f86da-4f90-71be-a2aa-c8744fa340d8.md) + [KF-ADR-019f86da-4f90-719a-866a-28afd48c21dc](./adr/KF-ADR-019f86da-4f90-719a-866a-28afd48c21dc.md) + [KF-ADR-019f86da-4f90-732e-826c-e994acc20716](./adr/KF-ADR-019f86da-4f90-732e-826c-e994acc20716.md) | why, use, verify | pre-release · native authority, independent six-state review, and exact bounded continuation implemented |
| How does Desktop open and remember a workspace without creating `.kungfu` on read? | [`mission-control-workspaces.md`](profiles/mission-control-workspaces.md) + [KF-ADR-019f86da-4f90-7d61-8afa-33d66ca05d36](./adr/KF-ADR-019f86da-4f90-7d61-8afa-33d66ca05d36.md) | why, use, verify | proposed · product design complete; implementation sliced |
| How can a first-time user manage agent work without a repository or predeclared Mission? | [`mission-control-workspaces.md`](profiles/mission-control-workspaces.md) + [KF-ADR-019f86da-4f90-7d61-8afa-33d66ca05d36](./adr/KF-ADR-019f86da-4f90-7d61-8afa-33d66ca05d36.md) | why, use, verify | proposed · Home Workspace and unassigned inbox designed |
| Why is agent-mediated guidance a first-class product interface rather than a later CLI integration? | [KF-ADR-019f86da-4f90-7667-b89e-18b1002e45f8](./adr/KF-ADR-019f86da-4f90-7667-b89e-18b1002e45f8.md) + [`mission-control-workspaces.md`](profiles/mission-control-workspaces.md) | why, use, verify | proposed · dual-first advice/action/receipt contract designed |
...
| When must a change open a minor or major (and when must it not)? | [`versioning.md`](development/versioning.md) (rule: KFD-1, adopted by KF-ADR-019f86da-4f90-7463-89b2-78cb94de9a0b) | verify | stable |
...
| How do I manage a long-running Mission, delegate Go work, inspect Cost/State/Proof, move evidence, cut over from Atlas, and hand an exact completion review to another agent? | [`mission-control.md`](profiles/mission-control.md) + [KF-ADR-019f86da-4f90-71be-a2aa-c8744fa340d8](./adr/KF-ADR-019f86da-4f90-71be-a2aa-c8744fa340d8.md) + [KF-ADR-019f86da-4f90-719a-866a-28afd48c21dc](./adr/KF-ADR-019f86da-4f90-719a-866a-28afd48c21dc.md) + [KF-ADR-019f86da-4f90-732e-826c-e994acc20716](./adr/KF-ADR-019f86da-4f90-732e-826c-e994acc20716.md) | why, use, verify | pre-release · native authority, full/thin portability, independent review, and mechanical continuation implemented |
...
| How is a kfx loaded, trusted, and confined? (the topology) | [`kfx-topology.md`](architecture/kfx-topology.md) (design: KF-ADR-019f86da-4f90-7afa-a1e1-0510f00916be; trust boundary KF-ADR-019f86da-4f90-79f1-8716-aca36b142847; uniform capability surface KF-ADR-019f86da-4f90-7789-8b48-620aa694acf9) | use | draft · load plan + `service` facet proposed |
| How do I write an agent-facing Kungfu Skill? | [`skills.md`](architecture/skills.md) (first implementation slice; decided by KF-ADR-019f86da-4f90-74c2-9cbb-24f1c34303bf) | use | draft |
