...
| How is exact product upgrade qualification sealed before publication and replayed locally? | [`publication-admission.md`](development/publication-admission.md) | use, verify | implemented · deterministic admission only; external publication and readback remain separate authorities |
...
- **Work Control / Initiative / Assignment / delegated responsibility / progress drift /
  ...
  ([`work-control.md`](profiles/work-control.md)), then *what the first commercial
