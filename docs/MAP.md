...
| What is Xinfa, how do projects compile one drift-aware authority into dual-first human/Agent routes and a portable Repository Context Pack, and how is the standalone boundary proved? | [`../xinfa/`](../xinfa/) + [ADR-0092](adr/ADR-0092-xinfa-product-and-incubation-boundary.md) + [ADR-0093](adr/ADR-0093-xinfa-dual-first-verified-context-contract.md) + [ADR-0094](adr/ADR-0094-xinfa-repository-context-pack.md) | why, use, verify | incubation · product identity, project/IR/Pack schemas, deterministic roots, bidirectional coverage, impact, offline verification, route parity, and clean extraction implemented; Capsule staged |
