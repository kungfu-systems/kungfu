...
| What is Xinfa, how does an Atlas project compile one immutable Xinfa Atlas with dual-first views while preserving legacy Pack roots, and how is the standalone boundary proved? | [`../xinfa/`](../xinfa/) + [ADR-0092](adr/ADR-0092-xinfa-product-and-incubation-boundary.md) + [ADR-0093](adr/ADR-0093-xinfa-dual-first-verified-context-contract.md) + [ADR-0094](adr/ADR-0094-xinfa-repository-context-pack.md) + [ADR-0095](adr/ADR-0095-xinfa-atlas-primitive-and-compatibility-boundary.md) | why, use, verify | incubation · Atlas/Project/IR/Pack schemas, immutable Atlas root, non-reinterpreted Pack compatibility, dual-view identity, impact, offline verification, and clean extraction implemented; Capsule staged |
