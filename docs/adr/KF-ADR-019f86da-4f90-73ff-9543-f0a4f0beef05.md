...
adr_id: KF-ADR-019f86da-4f90-73ff-9543-f0a4f0beef05
decision_status: accepted
implementation_status: staged
implementation_prs: [https://github.com/kungfu-systems/kungfu/pull/517, https://github.com/kungfu-systems/kungfu/pull/526, https://github.com/kungfu-systems/kungfu/pull/558, https://github.com/kungfu-systems/kungfu/pull/580, https://github.com/kungfu-systems/kungfu/pull/606, https://github.com/kungfu-systems/kungfu/pull/619, https://github.com/kungfu-systems/kungfu/pull/669, https://github.com/kungfu-systems/kungfu/pull/699, https://github.com/kungfu-systems/kungfu/pull/1097, https://github.com/kungfu-systems/kungfu/pull/1143, https://github.com/kungfu-systems/kungfu/pull/1510, https://github.com/kungfu-systems/kungfu/pull/1585, https://github.com/kungfu-systems/kungfu/pull/2586, https://github.com/kungfu-systems/kungfu/pull/2822, https://github.com/kungfu-systems/kungfu/pull/2827, https://github.com/kungfu-systems/kungfu/pull/2843]
qualification_refs: [crates/trunk/src/main.rs, crates/trunk/src/launch.rs, crates/trunk/src/help.rs, framework/core/src/python/kungfu/cli/help_manifest.py, framework/core/src/python/kungfu/cli/help_projection.py, framework/core/src/python/kungfu/cli/surface_contract.registry.json, framework/core/src/python/kungfu/cli/tui_runtime.py, developer/sdk/tests/contract-cli.test.mjs, framework/core/tests/python/test_cli_help_manifest.py, framework/core/tests/python/test_cli_progressive_help.py, framework/core/tests/python/test_agent_native_first_run_pty.py, framework/core/tests/python/test_agent_native_terminal_contract.py, framework/tui/src/agent-work-lab-view.tsx, framework/tui/src/agent-work-lab-view.test.ts, framework/core/.gyp/run-freeze.js, product/scripts/qualify-product-cache-home.mjs, product/scripts/qualify-product-cache-home.test.mjs, scripts/alpha-macos-overflow.test.mjs, scripts/verify.mjs]
...
# KF-ADR-019f86da-4f90-73ff-9543-f0a4f0beef05: Rust host trunk, layered CLI, and the assembled runtime distribution
...
- Status: accepted; stages 1–3 are integrated on `dev/v4/v4.0`, including the
  ...
  and the generated root/help contract. Interactive bare `kungfu` now selects
  the bundled Node TUI while explicit command subtrees remain canonical; the
  former `tui` subcommand is retired. The ADR remains `staged` until an alpha
  promotion binds full product qualification; development integration alone
  is not an `implemented` settlement under KF-ADR-019f86da-4f90-7b6b-ae6d-76cea57487f2.
- Date: 2026-07-10
...
- Related: [`docs/research/rust-host-spike.md`](../research/rust-host-spike.md)
  ...
  [KF-ADR-019f86da-4f90-7739-aa31-52af27bc4470](KF-ADR-019f86da-4f90-7739-aa31-52af27bc4470.md) (the trunk becomes the
  outermost load-bearing ring at runtime, as the launcher is at build time);
  [KF-ADR-019f86da-4f90-7626-861e-3fdee887abd2](KF-ADR-019f86da-4f90-7626-861e-3fdee887abd2.md) (stage-0 toolchain
  delegation; the trunk is its runtime sibling);
  [KF-ADR-019f86da-4f90-7d41-a4a0-e6b01d4b31c6](KF-ADR-019f86da-4f90-7d41-a4a0-e6b01d4b31c6.md) (extension
  ...
  [KF-ADR-019f86da-4f90-7ecd-9660-81f9f74dc416](KF-ADR-019f86da-4f90-7ecd-9660-81f9f74dc416.md) (the
...
command-by-command in KF-ADR-019f86da-4f90-7a4b-b1a3-256ce6fa3f06. A current Python orchestration command can remain
...
3. **User surface** — implement a layer in the language its users consume and
   ...
   [KF-ADR-019f86da-4f90-7739-aa31-52af27bc4470](KF-ADR-019f86da-4f90-7739-aa31-52af27bc4470.md)).
...
| Node domain | the presentation and the JS ecosystem | TUI, sdk/kfx build, GUI side, the js-kfx execution contract |
...
KF-ADR-019f86da-4f90-7a4b-b1a3-256ce6fa3f06 is the current command-placement ledger for this table. In particular,
...
toolchain ([KF-ADR-019f86da-4f90-7626-861e-3fdee887abd2](KF-ADR-019f86da-4f90-7626-861e-3fdee887abd2.md) lineage). The
...
[KF-ADR-019f86da-4f90-7d41-a4a0-e6b01d4b31c6](KF-ADR-019f86da-4f90-7d41-a4a0-e6b01d4b31c6.md): its gate 1
...
As of 2026-07-31, source acceptance also rejects reintroduction of the retired
product packager name, bootloader state, third product-host form, hooks/specs,
or compiled-product terminology outside the exact historical retirement ledger.
This is implementation hardening of the accepted assembled target, not a new
...
- Product-host packaging and KFX Python AOT are separate boundaries. The
  product packager path is retired; `engage nuitka` remains the qualified
  Python-AOT KFX bridge governed by
  KF-ADR-019f86da-4f90-7d41-a4a0-e6b01d4b31c6 and does not regain product-host
  authority.
