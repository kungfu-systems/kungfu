...
qualification_refs: [crates/trunk/src/main.rs, crates/trunk/src/launch.rs, crates/trunk/src/help.rs, framework/core/src/python/kungfu/cli/help_manifest.py, framework/core/src/python/kungfu/cli/help_projection.py, framework/core/src/python/kungfu/cli/surface_contract.registry.json, framework/core/src/python/kungfu/cli/tui_runtime.py, framework/core/tests/python/test_cli_help_manifest.py, framework/core/tests/python/test_cli_progressive_help.py, framework/tui/src/agent-work-lab-view.tsx, framework/tui/src/agent-work-lab-view.test.ts, framework/core/.gyp/run-freeze.js, scripts/verify.mjs]
