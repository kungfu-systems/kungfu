...
adr_id: KF-ADR-019f86da-4f90-71be-a2aa-c8744fa340d8
...
implementation_prs: [https://github.com/kungfu-systems/kungfu/pull/585, https://github.com/kungfu-systems/kungfu/pull/1391, https://github.com/kungfu-systems/kungfu/pull/1553, https://github.com/kungfu-systems/kungfu/pull/1563, https://github.com/kungfu-systems/kungfu/pull/1843]
closure_commit: bcbe4abe0918e65647e9df7c2309ef489b1e16d4
qualification_refs: [extensions/dogfood/domain-profile.json, extensions/dogfood/dogfood-actions/domain/dogfood.py, framework/core/src/python/kungfu/dogfood.py, framework/core/src/python/kungfu/cli/commands/dogfood.py, framework/core/tests/python/test_dogfood_profile.py, crates/trunk/src/launch.rs, docs/qualification/native-dogfood-feedback-loop.md]
review_state: self-reviewed
sensitivity: public
sources: [architecture-decisions, local-files, user-consensus]
period: 2026-07-11/2026-07-24
theme: mission-go-responsibility-and-native-dogfood
confidence: high
evidence_grade: B
last_reviewed: 2026-07-29
ai_provenance: GPT-5 via Codex on 2026-07-29; based on the accepted Mission and Go decision, native Dogfood Domain Profile, Assignment gates, operational-hardening qualification, migration qualification, protected PR evidence, a signed Product direct-trunk byte-integrity probe, and the queue-lifecycle reconciliation source qualification; no claim about the still-unqualified installed queue-lifecycle build, unobserved installed runtimes, or future federation members
---

# KF-ADR-019f86da-4f90-71be-a2aa-c8744fa340d8: Mission Control composes Mission and Go responsibility over runtime facts

- Status: accepted; initial Atlas Mission/Go admission implemented; query,
  assessment, and Dogfood operational-hardening slices staged
- Date: 2026-07-11
...
- Related: KF-ADR-019f86da-4f90-791c-9b90-4888cca36327 defines Episode; KF-ADR-019f86da-4f90-7e38-b72f-ef8829e14104 defines proof-carrying runtime-fact
  queries; KF-ADR-019f86da-4f90-7d81-90a0-d144fc27fe03 defines declaration and fact admission; KF-ADR-019f86da-4f90-7b3f-9ef3-84f5a878f302 defines
  durable KFD-2 assessment; KF-ADR-019f86da-4f90-726e-b31f-ed180aa2e7a8 defines self-contained Episode bundles.
...
derived from admitted runtime facts and whose trust claims use KF-ADR-019f86da-4f90-7e38-b72f-ef8829e14104 and
KF-ADR-019f86da-4f90-7b3f-9ef3-84f5a878f302.
...
Mission/Go observations are recorded and admitted under KF-ADR-019f86da-4f90-7d81-90a0-d144fc27fe03 declarations.
Current, historical, and differential state uses KF-ADR-019f86da-4f90-7e38-b72f-ef8829e14104:
...
admission, an KF-ADR-019f86da-4f90-7e38-b72f-ef8829e14104 query, and KF-ADR-019f86da-4f90-7b3f-9ef3-84f5a878f302 assessments operate over the imported
...
the existing KF-ADR-019f86da-4f90-726e-b31f-ed180aa2e7a8 Episode bundle.
...
### 11. Dogfood feedback is native responsibility evidence

Dogfood feedback is a first-party Domain Profile over immutable Findings,
owned Issues, explicit transitions, bounded relevance, and consideration
receipts. Findings are observations; Issues are responsibility records. A
federated view preserves each project or Home component cut and reports
unavailable members instead of flattening them into one mutable queue.

Assignment admission, kickoff, and closeout require a dogfood consideration
receipt. The receipt records which relevant Issues were considered and their
disposition without requiring every Issue to block unrelated work. Starvation
remains explicit and policy-bound.

Atlas JSONL dogfood history enters this model through a lossless,
source-root-bound migration. Retry is idempotent, source bytes remain retained
for verification, and Atlas becomes a read-only compatibility projection only
after the native Product path is qualified. This is an explicit authority
transition under section 6, not a permanent dual-write arrangement.

Product qualification also treats the signed Python runtime tree as immutable.
Every direct trunk dispatch supplies Python's no-bytecode mode at the process
boundary, so read-only Dogfood and Work operations cannot recompile packaged
modules and invalidate the application signature. Qualification compares the
complete signed-bundle content digest and deep codesign before and after a
direct-trunk Dogfood operation.
...
4. Add one proof-carrying Mission/Go state query at head and one exact cut.
   **Implemented:** KF-ADR-019f86da-4f90-7e38-b72f-ef8829e14104 now accepts the domain-neutral `fact-state` object,
...
5. Add deterministic completion and reasonable-progress assessors and expose
   ...
   **Implemented:** the saved Mission Control profile persists KF-ADR-019f86da-4f90-7b3f-9ef3-84f5a878f302
...
The Dogfood responsibility slice now also stages explicit delivery-versus-
resolution reconciliation, exact-current-Issue-root fencing, bounded recurrent
Finding clustering, federated starvation cuts, and one canonical impact policy.
Source qualification and protected PR evidence establish delivery for this
slice; they do not by themselves resolve an Issue or qualify an installed
Product.
...
- Dogfood Findings, Issues, transitions, and consideration receipts reproduce
  at the same component cuts; migration retries do not duplicate native facts
  or discard Atlas source bytes.
...
- **Run KFD-2 after every agent event.** Rejected by KF-ADR-019f86da-4f90-7b3f-9ef3-84f5a878f302; assessments are
