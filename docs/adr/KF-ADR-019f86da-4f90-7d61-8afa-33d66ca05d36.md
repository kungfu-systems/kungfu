...
- Related: KF-ADR-019f86da-4f90-7e58-bb03-bee0f101dc01 defines workspace-local `.kungfu`; KF-ADR-019f86da-4f90-7394-9953-5dbb467859fa defines the
  per-user supervisor and per-data-root coordinator; the native Work Control contract defines Mission
...
Mission bodies, Go state, facts, proofs, or imported source payloads. A missing
...
projections as needed. A completed source import, native Mission, Go, assessment,
