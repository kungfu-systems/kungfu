...
qualification_refs: [extensions/work-control/contracts/world.json, extensions/work-control/contracts/facts.json, extensions/work-control/work-control-actions/domain/work_control.py, framework/core/tests/python/test_work_control_profile.py, framework/core/tests/python/test_projects.py, commit:d435ad578878d75839b27dff03ae82d3789d4870, scripts/run-native-kfx-admission-tests.mjs]
...
ai_provenance: GPT-5 via Codex on 2026-07-21; based on the Work Control Profile contracts, KFD-7 role contract, repository tests, and user-authorized terminology decision; no claim about unobserved deployed runtimes
---
...
- Date: 2026-07-21
- Category: Work Control / L3 identity / compatibility
- Related: [Work Control Profile](../profiles/work-control.md),
  [KF-ADR-019f9771-4c20-7e2c-8e7c-3f3cb3f1b9bd](KF-ADR-019f9771-4c20-7e2c-8e7c-3f3cb3f1b9bd.md), and
  [KF-ADR-019f86da-4f90-77c0-827b-fe1a3aa43e2b](KF-ADR-019f86da-4f90-77c0-827b-fe1a3aa43e2b.md)

## Context

The first Work Control Profile named its persistent intent container
...
Existing `kungfu.work-control` worlds, surfaces, payloads, receipts, and
...
vocabulary. The Profile identity in this decision was
`kungfu.work-control`; that clause is superseded for new installations by
[KF-ADR-019f9771-4c20-7e2c-8e7c-3f3cb3f1b9bd](KF-ADR-019f9771-4c20-7e2c-8e7c-3f3cb3f1b9bd.md).
This historical decision remains the authority for the immutable
Initiative/Assignment world and legacy fact boundary.

### 2. Legacy evidence is read-only and keeps its exact identity

Contract world `kungfu.work-control`, versions 1 through 3, and its
...
- [PR #1720](https://github.com/kungfu-systems/kungfu/pull/1720) stages the
  rooted Initiative family blueprint, child Assignment graph, terminal
  coverage, and residual-only continuation contract.
