...
qualification_refs: [extensions/work-control/contracts/world.json, extensions/work-control/contracts/facts.json, extensions/work-control/compatibility/v3.1.json, extensions/work-control/work-control-actions/domain/work_control.py, framework/core/tests/python/test_work_control_profile.py, framework/core/tests/python/test_atlas_storage.py, commit:d435ad578878d75839b27dff03ae82d3789d4870, scripts/run-native-kfx-admission-tests.mjs]
...
`kungfu.mission-control`; that clause is superseded for new installations by
