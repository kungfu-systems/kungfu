...
| Xinfa Atlas | immutable declared knowledge, verification state, omissions, routes, and epistemic closure at one cut | runtime actions, mutable Initiative/Assignment state, Git history, or publication success |
...
During bridge operation, External source remains the Initiative/Assignment authority described by
the native Work Control contract and Kungfu records sourced imports. A later native cutover is an
...
Initiative/Assignment authority; Xinfa may compile those facts as provider input, but it
does not become a second Initiative/Assignment database. Long-lived dual writes remain
invalid.
...
Project Cut serialization cannot by itself close a Assignment or establish a
...
- source import, native Initiative/Assignment facts, and authority cutover cannot create two
...
- Initiative/Assignment authority can move later through an auditable cutover instead of a
...
Initiative/Assignment authority, make Git or GitHub a second Fact or completion authority,
