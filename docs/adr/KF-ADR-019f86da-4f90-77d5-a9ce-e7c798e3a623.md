...
qualification_refs: [framework/project-cut/publication.contract.json, framework/project-cut/schema/settlement-publication-request-v1.schema.json, framework/project-cut/schema/settlement-publication-manifest-v1.schema.json, framework/project-cut/schema/settlement-publication-observation-v1.schema.json, framework/project-cut/schema/settlement-publication-state-v1.schema.json, scripts/check-project-cut-publication.test.mjs, framework/work-history-selector/work-history-selector.contract.json, scripts/check-work-history-selector.test.mjs, framework/work-design-advisor/work-design-advisor.contract.json, scripts/check-work-design-advisor.test.mjs, framework/work-design-policy-replay/work-design-policy-replay.contract.json, scripts/check-work-design-policy-replay.test.mjs, framework/work-design-open-card/work-design-open-card.contract.json, scripts/check-work-design-open-card.test.mjs]
