...
implementation_prs: [https://github.com/kungfu-systems/kungfu/pull/958, https://github.com/kungfu-systems/kungfu/pull/962, https://github.com/kungfu-systems/kungfu/pull/1779, https://github.com/kungfu-systems/kungfu/pull/1842]
qualification_refs: [framework/project-cut/publication.contract.json, framework/project-cut/schema/settlement-publication-request-v1.schema.json, framework/project-cut/schema/settlement-publication-manifest-v1.schema.json, framework/project-cut/schema/settlement-publication-observation-v1.schema.json, framework/project-cut/schema/settlement-publication-state-v1.schema.json, scripts/check-project-cut-publication.test.mjs, framework/work-history-selector/work-history-selector.contract.json, scripts/check-work-history-selector.test.mjs]
