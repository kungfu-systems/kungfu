...
implementation_prs: [https://github.com/kungfu-systems/kungfu/pull/958, https://github.com/kungfu-systems/kungfu/pull/962, https://github.com/kungfu-systems/kungfu/pull/1779]
qualification_refs: [framework/project-cut/publication.contract.json, framework/project-cut/schema/settlement-publication-request-v1.schema.json, framework/project-cut/schema/settlement-publication-manifest-v1.schema.json, framework/project-cut/schema/settlement-publication-observation-v1.schema.json, framework/project-cut/schema/settlement-publication-state-v1.schema.json, scripts/check-project-cut-publication.test.mjs]
