...
qualification_refs: [framework/core/runtime/kungfu-diagnostics.contract.json, scripts/check-health-diagnostics-contract.test.mjs, framework/core/tests/python/test_recovery.py, framework/core/tests/python/test_episode_control.py, docs/qualification/unified-recovery.md]
