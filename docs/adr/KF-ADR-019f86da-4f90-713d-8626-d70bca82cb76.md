...
implementation_prs: [https://github.com/kungfu-systems/kungfu/pull/1207, https://github.com/kungfu-systems/kungfu/pull/2095, https://github.com/kungfu-systems/kungfu/pull/2096, https://github.com/kungfu-systems/kungfu/pull/2112]
qualification_refs: [framework/data-protection/kungfu-data-protection.contract.json, tests/fixtures/data-protection-contract/cases.json, scripts/check-data-protection-contract.test.mjs, framework/data-protection/work-agent-history.contract.json, scripts/check-work-agent-history-continuity.test.mjs, framework/core/tests/python/test_run_product_path.py, framework/core/tests/python/test_assignment_orchestration.py, framework/core/tests/python/test_workspace_federation.py]
...
ai_provenance: GPT-5 via Codex on 2026-08-01; based on the admitted durable history data-protection Assignment, current domain contracts, retained adversarial fixtures, local Work and Agent source qualification, and retained Assignment seal successor qualification; installed-product migration, remaining history domains, public release qualification, and physical-media durability remain unobserved
---

# KF-ADR-019f86da-4f90-713d-8626-d70bca82cb76: Freeze workspace `.kungfu` home layout v1

- Status: accepted; implementation staged in PRs #1207, #2095, #2096, and #2112
- Date: 2026-07-21
