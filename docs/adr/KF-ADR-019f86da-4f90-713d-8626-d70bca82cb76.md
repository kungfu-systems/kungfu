...
adr_id: KF-ADR-019f86da-4f90-713d-8626-d70bca82cb76
decision_status: accepted
implementation_status: staged
implementation_prs: [https://github.com/kungfu-systems/kungfu/pull/1207, https://github.com/kungfu-systems/kungfu/pull/2095, https://github.com/kungfu-systems/kungfu/pull/2096, https://github.com/kungfu-systems/kungfu/pull/2113, https://github.com/kungfu-systems/kungfu/pull/2118, https://github.com/kungfu-systems/kungfu/pull/2810]
qualification_refs: [framework/data-protection/kungfu-data-protection.contract.json, tests/fixtures/data-protection-contract/cases.json, scripts/check-data-protection-contract.test.mjs, framework/data-protection/work-agent-history.contract.json, scripts/check-work-agent-history-continuity.test.mjs, framework/data-protection/project-cut-dogfood-history.contract.json, scripts/check-project-cut-dogfood-history.test.mjs, framework/core/tests/python/test_exit_bundle.py, framework/core/tests/python/test_run_product_path.py, framework/core/tests/python/test_assignment_orchestration.py, framework/core/tests/python/test_workspace_federation.py, scripts/verify-agent-pack.mjs, framework/core/tests/python/test_agent_first_entry.py, scripts/check-git-episode-provider.test.mjs]
...
ai_provenance: GPT-5 via Codex on 2026-08-01; based on the admitted durable history data-protection Assignment, current domain contracts, retained adversarial fixtures, local Work, Agent, Project Cut, and Dogfood source qualification, and retained Assignment seal successor qualification; installed-product migration, remaining history domains, public release qualification, and physical-media durability remain unobserved
---

# KF-ADR-019f86da-4f90-713d-8626-d70bca82cb76: Freeze workspace `.kungfu` home layout v1

- Status: accepted; implementation staged in PRs #1207, #2095, #2096, #2113, #2118, and #2810
- Date: 2026-07-21
- Category: workspace persistence / compatibility
- Related:
  [KF-ADR-019f86da-4f90-70c5-b572-89ec183b37de](KF-ADR-019f86da-4f90-70c5-b572-89ec183b37de.md),
  ...
  [KF-ADR-019f86da-4f90-741b-8f16-b27fcd99d0df](KF-ADR-019f86da-4f90-741b-8f16-b27fcd99d0df.md),
  [KF-ADR-019f86da-4f90-77d5-a9ce-e7c798e3a623](KF-ADR-019f86da-4f90-77d5-a9ce-e7c798e3a623.md)

## Context

KF-ADR-019f86da-4f90-7e58-bb03-bee0f101dc01 made workspace-local `.kungfu/` the default fact-ledger home, but the
...
| `initiatives/` | durable | low-frequency workspace Initiative input |
...
The additive
[`kungfu.data-protection.contract/v1`](../../framework/data-protection/kungfu-data-protection.contract.json)
projection classifies accepted semantic history, rebuildable projections,
ephemeral coordination, retained evidence, and unclassified candidates across
all registered owner domains. It does not become a second storage or schema
authority: every durable identity, verifier, export, migration, and loss record
continues to come from the declared domain contract. Unknown or conflicting
ownership fails closed before migration, garbage collection, reset, uninstall,
or overwrite can proceed.
...
strengthens KF-ADR-019f86da-4f90-741b-8f16-b27fcd99d0df: derivation detects drift; the declaration makes accepting
...
KF-ADR-019f86da-4f90-77d5-a9ce-e7c798e3a623 section 7 remains in force. The concise boundary is:
...
There is one deliberate nuance. KF-ADR-019f86da-4f90-77d5-a9ce-e7c798e3a623 permits low-frequency, selected
...
immutable store under KF-ADR-019f86da-4f90-77d5-a9ce-e7c798e3a623 and belongs in the ignored class once a
...
requires a separate decision and Assignment.
...
- Run `./shifu check:work-agent-history-continuity`: source contracts must keep
  Work and Agent durable roots, native-to-managed projection, migration refusal,
  and GUI/TUI entrypoint affordances in parity without requiring a product build.
- Run the Assignment orchestration and workspace federation tests against an
  exact-checkout Qualified Core. Equivalent retained witnesses must collapse,
  one strictly dominating successor may resolve, and equal or incomparable
  states must remain unresolved. The strict Catalog readback must retain both
  the selected and superseded sealed-state roots in its proof surface.
...
- Product and Agent entrypoints now have one checked protection vocabulary for
  composing these workspace classes without redefining their domain roots.
- Retained snapshots of one Assignment no longer become competing authorities
  merely because the Assignment was sealed more than once. Resolution remains
  fail closed unless one state is an exact typed endpoint or a unique,
  component-wise strict successor of every alternative.
