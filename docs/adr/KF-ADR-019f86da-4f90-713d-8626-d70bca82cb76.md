...
qualification_refs: [framework/data-protection/kungfu-data-protection.contract.json, tests/fixtures/data-protection-contract/cases.json, scripts/check-data-protection-contract.test.mjs]
...
ai_provenance: GPT-5 via Codex on 2026-08-01; based on the admitted durable history data-protection Assignment, current domain contracts, retained adversarial fixtures, and local source qualification; installed-product migration, cross-entrypoint parity, public release qualification, and physical-media durability remain unobserved
---
