...
qualification_refs: [framework/core/data-protection/kungfu-data-protection.contract.json, tests/fixtures/data-protection-contract/cases.json, scripts/check-data-protection-contract.test.mjs, framework/core/data-protection/work-agent-history.contract.json, scripts/check-work-agent-history-continuity.test.mjs, framework/core/data-protection/project-cut-dogfood-history.contract.json, scripts/check-project-cut-dogfood-history.test.mjs, framework/core/tests/python/test_exit_bundle.py, framework/core/tests/python/test_run_product_path.py, framework/core/tests/python/test_assignment_orchestration.py, framework/core/tests/python/test_workspace_federation.py, scripts/verify-agent-pack.mjs, framework/core/tests/python/test_agent_first_entry.py, scripts/check-git-episode-provider.test.mjs]
...
The additive
[`kungfu.data-protection.contract/v1`](../../framework/core/data-protection/kungfu-data-protection.contract.json)
