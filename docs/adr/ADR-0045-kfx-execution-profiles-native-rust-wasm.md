...
qualification_refs: [docs/research/libwasm-embedding-membrane-spike.md]
...
- `docs/architecture/adapters.md` records the current zero-copy boundary: C++, Python, and
...
[`docs/research/libwasm-embedding-membrane-spike.md`](../research/libwasm-embedding-membrane-spike.md).
