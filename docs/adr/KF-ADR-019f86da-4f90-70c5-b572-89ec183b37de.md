...
qualification_refs: [framework/core/tests/python/test_content_store_facade.py, framework/core/tests/storage-node-binding.test.js, framework/core/tests/core-platform-package.test.js, framework/core/tests/node-api-authority.test.js, framework/core/src/libkungfu/src/runtime/storage/domain_dispatch.cpp, framework/core/src/libkungfu/src/runtime/storage/query_render.cpp, framework/core/src/libkungfu/src/runtime/storage/service_operation_catalog.cpp, framework/core/src/python/kungfu/storage/fact_kernel_integrity.py, framework/core/src/python/kungfu/storage/fact_root_canonical.py]
review_state: self-reviewed
sensitivity: public
confidence: high
evidence_grade: B
last_reviewed: 2026-09-01
ai_provenance: GPT-5 via Codex on 2026-08-26 and 2026-09-01; based on repository contracts, the exact feature diff, local source qualification, and the protected pull request; installed-product, cross-platform artifact, physical durability, and public release qualification are not claimed
---
...
Pull request 3436 extends this staged contract with a bounded internal
