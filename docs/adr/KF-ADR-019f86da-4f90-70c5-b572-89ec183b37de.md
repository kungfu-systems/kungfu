...
ai_provenance: GPT-5 via Codex on 2026-08-26; based on repository contracts, the exact feature diff, local source qualification, and the protected pull request; installed-product, cross-platform artifact, physical durability, and public release qualification are not claimed
---
