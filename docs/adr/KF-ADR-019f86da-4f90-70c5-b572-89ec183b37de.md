...
```sh
kungfu storage import --repo <source-repo> --json
...
kungfu storage fsck --repo <source-repo> --json
```
...
- `atlas verify` recomputes hashes from the consumer repo and compares them with
