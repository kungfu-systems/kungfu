...
# ADR-0093: Xinfa compiles one verified context for humans and Agents
...
SHIFU-ADR-0006 already separates document role from verification mode and gives
projects a conformance envelope. It intentionally does not own a semantic graph,
impact analysis, or context compiler. ADR-0092 assigns those authorities to
