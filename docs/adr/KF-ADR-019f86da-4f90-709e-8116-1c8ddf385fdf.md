...
qualification_refs: [framework/work/project-cut/settlement.contract.json, framework/work/project-cut/fixtures/public-runtime-episode/bundle.json, framework/work/project-cut/fixtures/public-runtime-episode/qualification.json, framework/work/project-cut/src/json-scanner.mjs, framework/work/project-cut/src/project-cut.mjs, scripts/check-project-cut-settlement.test.mjs, scripts/check-project-cut-settlement-integration.test.mjs, scripts/run-project-cut-entry.mjs]
