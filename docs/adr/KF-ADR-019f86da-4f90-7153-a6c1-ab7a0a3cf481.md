...
adr_id: KF-ADR-019f86da-4f90-7153-a6c1-ab7a0a3cf481
...
# KF-ADR-019f86da-4f90-7153-a6c1-ab7a0a3cf481: managed session host placement — a shared durable host for multi-window session workspaces
...
- Related: KF-ADR-019f86da-4f90-7e5e-ae22-2a8fc24086f1 pinned the capability SDK contract — tier declaration and
  the zero-copy-vs-serialized split for the GUI view plane. KF-ADR-019f86da-4f90-7789-8b48-620aa694acf9 pinned the
  ...
  capability relay. KF-ADR-019f86da-4f90-7513-9c95-f19e0c7faa80 pinned the v4 frontend platform. This ADR pins
...
2. **The moat (KF-ADR-019f86da-4f90-7e5e-ae22-2a8fc24086f1) keeps zero-copy journal/state access in the trusted
...
3. **The uniform capability surface (KF-ADR-019f86da-4f90-7789-8b48-620aa694acf9) already tolerates an out-of-process
...
per-session window — reaches the host through `ipcMain`, reusing the KF-ADR-019f86da-4f90-7789-8b48-620aa694acf9
...
KF-ADR-019f86da-4f90-7789-8b48-620aa694acf9 relay rather than inventing transport; and it cleanly separates the
session host (node-pty/tmux) from the zero-copy journal moat that stays in the
trusted renderer under KF-ADR-019f86da-4f90-7e5e-ae22-2a8fc24086f1. tmux remains a backend detail; the product
...
- **Neutral.** KF-ADR-019f86da-4f90-7e5e-ae22-2a8fc24086f1 is unaffected: journal/state zero-copy stays in the
  trusted renderer. KF-ADR-019f86da-4f90-7789-8b48-620aa694acf9's relay gains a first-party, non-sandbox consumer.
...
relay to round-trip `stop()` is a larger change to an KF-ADR-019f86da-4f90-7789-8b48-620aa694acf9 contract module
...
window host out of the KF-ADR-019f86da-4f90-7e5e-ae22-2a8fc24086f1 / KF-ADR-019f86da-4f90-7789-8b48-620aa694acf9 capability contract: it is a shell
