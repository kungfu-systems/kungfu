...
adr_id: KF-ADR-019f86da-4f90-741b-8f16-b27fcd99d0df
...
# KF-ADR-019f86da-4f90-741b-8f16-b27fcd99d0df: the journal container epoch is derived from its layout, and cross-epoch replay is offline conversion
...
- Related: [KF-ADR-019f86da-4f90-7bf2-9789-1b88bf3ed265](KF-ADR-019f86da-4f90-7bf2-9789-1b88bf3ed265.md) (parent policy —
  released closed-layout compatibility baseline; hot path speaks one epoch, cold
  path carries explicit migration/decode), [KF-ADR-019f86da-4f90-7179-a900-c40bdb498910](KF-ADR-019f86da-4f90-7179-a900-c40bdb498910.md)
  (the page/frame publish barrier this format must not disturb),
  [KF-ADR-019f86da-4f90-7f8a-9bff-e4f7683da35f](KF-ADR-019f86da-4f90-7f8a-9bff-e4f7683da35f.md) (the page-open
  policies that gate who may initialize a page),
  [KF-ADR-019f86da-4f90-7d2c-aaa5-974ca5e38654](KF-ADR-019f86da-4f90-7d2c-aaa5-974ca5e38654.md) (a layout
...
the only safe behavior, and KF-ADR-019f86da-4f90-7bf2-9789-1b88bf3ed265 already ratifies this stance at the policy
level ("hot path speaks one schema layout epoch"). What KF-ADR-019f86da-4f90-7bf2-9789-1b88bf3ed265 does *not*
...
1. **The epoch is a hand-edited constant and is blind to size-preserving layout
   ...
   threatens KF-ADR-019f86da-4f90-7bf2-9789-1b88bf3ed265's "released v4+ data is not silently stranded."
...
This ADR operationalizes KF-ADR-019f86da-4f90-7bf2-9789-1b88bf3ed265 for the journal container. It changes no wire
...
3. **The epoch is derived from the layout, not hand-maintained.** The epoch is a
   ...
   frame checksum (KF-ADR-019f86da-4f90-7a7d-99ba-c5c18088d450) and content hashes (KF-ADR-019f86da-4f90-7d2c-aaa5-974ca5e38654); it is never written
...
5. **Cross-epoch replay is offline conversion, exclusively.** Reading historical
   ...
   export. This is the concrete realization of KF-ADR-019f86da-4f90-7bf2-9789-1b88bf3ed265's "cold-path
   ...
   hidden adapter into the zero-copy hot path (KF-ADR-019f86da-4f90-7bf2-9789-1b88bf3ed265 replacement criterion 6).
...
7. **The offline converter is deferred; the standing contract is
   ...
   KF-ADR-019f86da-4f90-7bf2-9789-1b88bf3ed265) do not trigger it. This keeps the deferral inside KF-ADR-019f86da-4f90-7bf2-9789-1b88bf3ed265's
...
- No hot-path cost, no wire/POD layout change, no change to the KF-ADR-019f86da-4f90-7179-a900-c40bdb498910
  publication barrier or the KF-ADR-019f86da-4f90-7f8a-9bff-e4f7683da35f page-open policies. `page_size` remains a
...
- **Make the reader epoch-tolerant (skip mismatched pages, warn).** Rejected: it
  puts a hidden translation in the zero-copy hot path (violates KF-ADR-019f86da-4f90-7bf2-9789-1b88bf3ed265
...
- **A self-describing / variable-length container header.** Rejected for the
  ...
  exists one layer up for payloads (`.fbs`/`.bfbs`, KF-ADR-019f86da-4f90-71eb-b4c0-376ca7bc7ad3); the container
  stays closed POD.
