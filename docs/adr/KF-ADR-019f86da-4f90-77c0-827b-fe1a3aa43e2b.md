...
implementation_prs: [https://github.com/kungfu-systems/kungfu/pull/1176, https://github.com/kungfu-systems/kungfu/pull/3127, https://github.com/kungfu-systems/kungfu/pull/3129, https://github.com/kungfu-systems/kungfu/pull/3135, https://github.com/kungfu-systems/kungfu/pull/3138]
qualification_refs: [framework/action/action-geometry.contract.json, framework/agent-work/kungfu-agent-work-domain-profile.contract.json, framework/core/src/libkungfu/src/runtime/action/action_geometry.cpp, framework/core/src/libkungfu/src/runtime/action/domain_profile.cpp, framework/core/src/libkungfu/src/runtime/action/profile_action.cpp, framework/core/src/libkungfu/src/runtime/action/action_runtime.cpp, framework/core/tests/python/test_action_runtime_shadow.py, framework/core/tests/python/test_agent_work_state_contract.py, scripts/check-agent-work-state-contract.test.mjs, developer/sdk/kfd/kfd-1/release-gate.json, framework/release/buildchain-kfd-runtime.mjs, docs/qualification/gates/release-admission-policy.json, scripts/verify-kungfu-release-admission.test.mjs]
...
The product-runtime adopter cut in PR #3127 exercises the same boundary at
release admission: KFD owns the category declaration and verifier semantics,
Buildchain supplies a protocol-neutral delivery gate, and Kungfu supplies only
its project-local git-commit artifact and evidence. Positive and fail-closed
vectors are bound to the exact KFD Alpha.65 and Buildchain Alpha.17 cuts, and
the cold-readonly adopter fixture proves those inputs remain available from a
fresh source checkout. This evidence does not let a category declaration mint
runtime, publication, certification, Fact, Episode, or adopter authority.
