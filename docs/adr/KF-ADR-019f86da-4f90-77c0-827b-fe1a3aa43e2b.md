...
1. [`action-geometry.contract.json`](../../framework/work/action/action-geometry.contract.json)
   plus the domain-neutral `kungfu.agent.action_geometry` evaluator;
2. [`kungfu-agent-work-domain-profile.contract.json`](../../framework/work/agent-work/kungfu-agent-work-domain-profile.contract.json)
...
[`buildchain-kfd-runtime.mjs`](../../product/release/buildchain-kfd-runtime.mjs),
[`kungfu-temporal-release-admission-facts.json`](../qualification/evidence/kungfu-temporal-release-admission-facts.json),
`release-admission-policy.json` (retained at commit `db0010dacd76f913a8dc2704faf0cfceb55b1553`),
and the public SDK
