...
adr_id: KF-ADR-019f86da-4f90-7789-8b48-620aa694acf9
...
# KF-ADR-019f86da-4f90-7789-8b48-620aa694acf9: the extension execution contract — a uniform capability surface across trust tiers
...
- Related: KF-ADR-019f86da-4f90-7e5e-ae22-2a8fc24086f1 pinned the tier declaration and the zero-copy-vs-serialized
  split for the GUI view plane. KF-ADR-019f86da-4f90-79f1-8716-aca36b142847 extended the trust boundary to the
...
KF-ADR-019f86da-4f90-79f1-8716-aca36b142847 gave the runtime plane a trust boundary. A source-verified first-party
...
2. **The trusted tier keeps zero-copy under the uniform surface.** Uniformity is
   ...
   channel of KF-ADR-019f86da-4f90-79f1-8716-aca36b142847, unchanged. When it is sandboxed, the same channel is
   carried over the child-process relay and returns serialized copies. The
   performance split KF-ADR-019f86da-4f90-79f1-8716-aca36b142847 cut along the trust axis is preserved; only the
   surface is unified.
...
capability surface. This is the production host the KF-ADR-019f86da-4f90-79f1-8716-aca36b142847 primitives were
built for.
...
- Native-compiled extension forms — carried in the feasibility map, not the
  first delivery.
- A Windows sandbox profile — consistent with KF-ADR-019f86da-4f90-79f1-8716-aca36b142847, the first cut targets
...
- A redirected mapping is consistent only under the single-writer discipline
  ...
  journal diverge.
- All of KF-ADR-019f86da-4f90-79f1-8716-aca36b142847's residual risk stands. Transparent interception does not
