...
qualification_refs: [crates/xinfa/qualification/standalone-smoke-v1.json, crates/xinfa/extraction-manifest.json, crates/xinfa/contract/xinfa-product-v2.json, framework/release/component-distribution.contract.json]
