...
content-addressed GitHub Artifacts. README and site projections may materialize
only from the same verified Passport after an exact merged-dev render. This
demonstrates the discoverable installed Agent Work Lab surface without claiming
provider continuity, macOS parity, durability, performance, production
deployment, implicit first-party or KFD authorization, or completion of P17.
