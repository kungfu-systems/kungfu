...
for the installed `kungfu agent brief` surface. It binds the exact build
coordinate, source revision, Buildchain Gate, renderer digest, bounded media,
and Release Passport through content-addressed GitHub Artifacts. It demonstrates
the discoverable installed agent surface without claiming provider continuity,
macOS parity, durability, performance, production deployment, or completion of
P17.
