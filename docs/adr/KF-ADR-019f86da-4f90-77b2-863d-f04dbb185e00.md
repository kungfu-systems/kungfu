...
qualification_refs: [framework/spec/invariant/kungfu-invariant-system.contract.json, framework/spec/invariant/kungfu-invariant.registry.json, scripts/kungfu-invariant.test.mjs, scripts/run-release-qualification.mjs]
...
- The registry and assembled runtime artifacts are KFD-1 welded surfaces.
