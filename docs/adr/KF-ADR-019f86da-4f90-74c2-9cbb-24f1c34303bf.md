...
implementation_prs: [https://github.com/kungfu-systems/kungfu/pull/3042]
qualification_refs: [framework/skill/schema/skill-runtime-audit-v2.schema.json, framework/core/tests/python/test_agent_console_contract.py, framework/core/tests/python/test_skill_lifecycle.py, framework/core/tests/python/test_episode_control.py, framework/tui/src/skill-runtime-audit.test.ts]
...
- Implementation: the original source/catalog slice and the shared
  ...
  managed-run projections now share one rooted audit model; broader lifecycle
  work remains governed by the Skill v2 amendment.
