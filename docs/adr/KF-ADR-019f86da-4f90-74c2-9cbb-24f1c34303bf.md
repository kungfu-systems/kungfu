...
adr_id: KF-ADR-019f86da-4f90-74c2-9cbb-24f1c34303bf
decision_status: accepted
amended_by: [KF-ADR-019fee22-e71d-7da9-8a44-9403c21a5d62]
implementation_status: partial
implementation_prs: [https://github.com/kungfu-systems/kungfu/pull/3042, https://github.com/kungfu-systems/kungfu/pull/3082]
qualification_refs: [framework/skill/schema/skill-runtime-audit-v2.schema.json, framework/skill/schema/skill-dependency-plan-v2.schema.json, framework/skill/schema/skill-dependency-invocation-receipt-v2.schema.json, framework/core/tests/python/test_agent_command_contract.py, framework/core/tests/python/test_agent_console_contract.py, framework/core/tests/python/test_skill_lifecycle.py, framework/core/tests/python/test_episode_control.py, framework/tui/src/skill-runtime-audit.test.ts]
review_state: legacy-unreviewed
sensitivity: public
last_reviewed: 2026-08-14
---

# KF-ADR-019f86da-4f90-74c2-9cbb-24f1c34303bf: Kungfu Skill as the agent context layer above kfx

## Amendment boundary

The
[Skill v2 contract decision](KF-ADR-019fee22-e71d-7da9-8a44-9403c21a5d62.md)
amends identity, class, scope, lifecycle, dependency, proof, recovery, and
compatibility semantics. This record's separation between agent-facing Skill
content and separately governed KFX runtime artifacts remains accepted.

- Status: accepted
- Date: 2026-07-05
- Implementation: the original source/catalog slice and the shared
  multi-surface runtime-audit stage have landed. Agent, CLI, GUI, TUI, and
  managed-run projections now share one rooted audit model. The successor
  delivery binds native command launch, independent structured transports,
  normalized config/dependency evidence, and the dependency plan/receipt chain;
  broader lifecycle work remains governed by the Skill v2 amendment.
...
- Related: KF-ADR-019f86da-4f90-7e5e-ae22-2a8fc24086f1 defines the v4 capability SDK contract and runtime-tier
  declaration. KF-ADR-019f86da-4f90-79f1-8716-aca36b142847 defines extension isolation and the trusted channel on
  the runtime plane. KF-ADR-019f86da-4f90-7789-8b48-620aa694acf9 defines the uniform capability surface across
...
- The first slice proves parsing, catalog/context generation, and assembled CLI
...
- assembled `dist/kungfu/kungfu skill validate/catalog/context/read/explain`
