...
that was the fastest route to dogfood Rewind and source import. That is useful
...
- If documentation only names the binding APIs, future agents may miss the C++
  ownership boundary. Concepts, maps, and Work Control docs must point back to
  this ADR.
