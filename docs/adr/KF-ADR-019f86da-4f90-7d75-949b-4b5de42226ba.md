...
qualification_refs: [framework/work/episode-provider/workspace-continuation.contract.json, framework/core/tests/python/test_workspace.py, framework/gui/src/main/workspace-selection.test.ts, scripts/check-project-cut-settlement-integration.test.mjs]
