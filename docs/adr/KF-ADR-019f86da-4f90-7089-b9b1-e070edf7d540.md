...
adr_id: KF-ADR-019f86da-4f90-7089-b9b1-e070edf7d540
...
# KF-ADR-019f86da-4f90-7089-b9b1-e070edf7d540: Xinfa baselines split into tracked witnesses and ignored local material
...
- Implements: the storage allocation of
  [KF-ADR-019f86da-4f90-77d5-a9ce-e7c798e3a623 §7](KF-ADR-019f86da-4f90-77d5-a9ce-e7c798e3a623.md)
  for `.xinfa/baselines`
...
KF-ADR-019f86da-4f90-77d5-a9ce-e7c798e3a623 §7 allocates `.xinfa/` into tracked declarations, policies, and
...
`.xinfa` and `.kungfu` remain distinct authorities per KF-ADR-019f86da-4f90-77d5-a9ce-e7c798e3a623 §7; moving
...
existed are rejected; the witness never consults an unsealed backfill for its
own inputs. The path fails closed when material is present but drifts, or when
