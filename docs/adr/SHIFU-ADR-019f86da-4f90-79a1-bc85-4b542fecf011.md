...
- Status: accepted and implemented; the bounded Production Graph v0 Core
  affected shadow, feedback and recovery, and execution-admission stages are
  merged, while the bounded local executor is pending protected review and merge
- Date: 2026-07-13
...
PR 2693 stages the bounded local executor behind that admission membrane. It
