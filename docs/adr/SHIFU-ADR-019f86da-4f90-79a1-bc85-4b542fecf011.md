...
PR 3200 supersedes the closed stale-cut PR 3188, unmerged PR 3033, and
fork-transport PR 3187, then qualifies the same build-free `conditional-go`
lowering boundary on a current protected source for the subgraph's `journal`
native-build node. Canonical Core
semantic authority now
