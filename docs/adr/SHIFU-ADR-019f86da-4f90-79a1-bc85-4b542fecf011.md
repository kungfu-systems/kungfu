...
PR 2975 supersedes the stale review objects in PRs 2964, 2970, and 2973 and adds one
bounded protected-CI shadow lane and exact local replay for the same admitted
Production Graph slice. Both lanes retain source, contract,
