...
PR 2964 adds one bounded protected-CI shadow lane and exact local replay for the
same admitted Production Graph slice. Both lanes retain source, contract,
