...
PR 3188 supersedes the unmerged PR 3033 and fork-transport PR 3187, then
qualifies the same build-free `conditional-go` lowering boundary on a current
protected source for the subgraph's `journal` native-build node. Canonical Core
