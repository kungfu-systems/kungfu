...
- Status: accepted and implemented; the bounded Production Graph v0 Core
  affected shadow loop is pending protected review, merge, and publication
- Date: 2026-07-13
