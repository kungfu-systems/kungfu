...
adr_id: KF-ADR-019f86da-4f90-7626-861e-3fdee887abd2
decision_status: accepted
implementation_status: partial
implementation_prs: [https://github.com/kungfu-systems/kungfu/pull/1670]
review_state: legacy-unreviewed
sensitivity: public
---

# KF-ADR-019f86da-4f90-7626-861e-3fdee887abd2: The shifu delegation protocol — what installed binaries bake in forever
...
- Related: [KF-ADR-019f86da-4f90-7739-aa31-52af27bc4470](KF-ADR-019f86da-4f90-7739-aa31-52af27bc4470.md) (the launcher is
...
## 2026-07-27 implementation slice: build-free KFD source inspection

PR [#1670](https://github.com/kungfu-systems/kungfu/pull/1670) extends the
repository-owned entrypoint pair with a bounded, build-free KFD inspection
family: `./shifu kfd status`, `query`, and `check`, plus compatibility aliases.
The routes execute before dependency bootstrap, read only checked-in
authorities, and carry the same POSIX and Windows entrypoint parity required by
this decision.

This slice does not change any of the four installed-binary protocol clauses.
It proves only that the welded entrypoints can expose one additional read-only
source capability without dependency installation, runtime initialization,
checkout mutation, or HOME mutation. The broader historical delegation
implementation remains `partial`; the PR does not reconstruct or close all
