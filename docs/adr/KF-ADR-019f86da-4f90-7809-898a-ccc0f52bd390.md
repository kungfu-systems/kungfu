...
qualification_refs: [framework/work/action/action.contract.json, framework/work/action/action-response.schema.json, framework/work/action/manifest.json, framework/work/action/migration-map.json, framework/work/action/action.test.mjs, framework/core/tests/python/test_action_command.py]
...
`framework/work/action/` is the single source package. Its manifest names every
