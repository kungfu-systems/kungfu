...
implementation_prs: []
qualification_refs: [crates/xinfa/fixtures/golden/assignment-route-corpus-v1.json, crates/xinfa/tooling/qualify-route-resolver.mjs, crates/xinfa/schema/task-envelope-v1.schema.json, crates/xinfa/schema/route-resolution-v1.schema.json]
review_state: self-reviewed
sensitivity: public
sources: [local-files, user-consensus]
period: 2026-07-17
theme: structured-task-route-resolution
confidence: high
evidence_grade: B
last_reviewed: 2026-07-17
---

# KF-ADR-019f86da-4f90-7178-b0b5-ff507589cc70: Automatic task context uses project-declared structured route resolution

- Status: accepted; staged
- Date: 2026-07-17
- Category: Xinfa / Agent context / Initiative-Assignment admission
...
and prevents an Agent from proving why a new task received one documentation
and implementation context rather than another.

## Decision

Projects declare route-resolution intent alongside each dual-first route:
subjects, required capabilities, owners, allowed roles, Initiative tracks, and
bounded lexical terms. Human and Agent routes in one parity group must declare
the same intent.

The Work coordinator produces an exact `xinfa.task-envelope/v1` from the durable
goal card, Initiative lens/track, acceptance criteria, ownership, dependencies,
...
selection semantics. Kungfu retains Initiative, Assignment, and parent-child authority.
...
- at least 20 retained real-task cases span at least four route families with
...
New tasks gain an auditable context predecessor and can fail before
