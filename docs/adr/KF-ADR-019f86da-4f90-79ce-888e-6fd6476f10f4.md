...
adr_id: KF-ADR-019f86da-4f90-79ce-888e-6fd6476f10f4
...
# KF-ADR-019f86da-4f90-79ce-888e-6fd6476f10f4: yijinjing separates lock-free publication from cursor, write, and page-lifetime ownership
...
- Related: [KF-ADR-019f86da-4f90-7179-a900-c40bdb498910](KF-ADR-019f86da-4f90-7179-a900-c40bdb498910.md),
  [KF-ADR-019f86da-4f90-7f8a-9bff-e4f7683da35f](KF-ADR-019f86da-4f90-7f8a-9bff-e4f7683da35f.md),
...
KF-ADR-019f86da-4f90-7179-a900-c40bdb498910 gives yijinjing a correct release/acquire publication protocol: one
...
- The former two-call reservation/commit surface acquired and released
  `writer_mtx_` in separate caller-controlled operations. Exceptions during
  page rollover, hooks, payload construction, or commit could strand the lock.
  Its unsynchronized variants also exposed mutable writer/journal state while
  still being able to map pages, allocate, take other locks, or perform file
  operations.
...
published frames through the KF-ADR-019f86da-4f90-7179-a900-c40bdb498910 acquire gate. "Lock-free" is reserved for
...
- `commit()` completes header/payload writes, publishes `length` last with the
  KF-ADR-019f86da-4f90-7179-a900-c40bdb498910 release store, advances the cursor, releases serialization, and only
...
No split compatibility adapter remains in the pre-release surface. Necessary
single-owner primitives are private implementation details, while every caller
owns one transaction from reservation through commit or automatic abort.
...
5. ARM and x86 publication stress from KF-ADR-019f86da-4f90-7179-a900-c40bdb498910 remains tear-free.
