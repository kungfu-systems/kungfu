...
adr_id: KF-ADR-019f86da-4f90-79f1-8716-aca36b142847
...
# KF-ADR-019f86da-4f90-79f1-8716-aca36b142847: extension isolation and the trusted channel on the runtime plane
...
- Related: KF-ADR-019f86da-4f90-7e5e-ae22-2a8fc24086f1 pinned the tier declaration and the zero-copy-vs-serialized
  split for the GUI view plane; KF-ADR-019f86da-4f90-7513-9c95-f19e0c7faa80 defined the node-integrated context a
  trusted extension needs. This ADR extends the tier model to the runtime plane
  and pins how trust is granted.

## Context

KF-ADR-019f86da-4f90-7e5e-ae22-2a8fc24086f1 gave the GUI **view** plane a real isolation tier: an installed
...
2. **Default tier: OS-level isolation, default-deny.** An untrusted
   ...
   transport-agnostic capability proxy KF-ADR-019f86da-4f90-7e5e-ae22-2a8fc24086f1's sandboxed tier already uses,
