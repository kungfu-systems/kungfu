...
adr_id: KF-ADR-019f86da-4f90-71eb-b4c0-376ca7bc7ad3
...
# KF-ADR-019f86da-4f90-71eb-b4c0-376ca7bc7ad3: authoritative structured facts have one schema owner — Hana POD or FlatBuffers
...
- Related: KF-ADR-019f86da-4f90-7bf2-9789-1b88bf3ed265 defines the released closed-layout compatibility baseline;
  KF-ADR-019f86da-4f90-70f3-9a0e-d502826fbc81 places action-recording semantics in the C++ membrane; KF-ADR-019f86da-4f90-7c76-bf49-3e804d3ba63f
  defines action-envelope semantics; KF-ADR-019f86da-4f90-7828-9142-46f9bca4b0f5 establishes the storage-specific
  Hana/FlatBuffers split; KF-ADR-019f86da-4f90-7a66-b427-f4bcd638d8bc confines raw FlatBuffers access to
  `kungfu::view`.
...
- KF-ADR-019f86da-4f90-7a55-9b15-93fcab44a33a describes FlatBuffers as a runtime schema over the POD layout.
...
- Raw C++ FlatBuffers/reflection access remains confined to `kungfu::view` per
  KF-ADR-019f86da-4f90-7a66-b427-f4bcd638d8bc.
...
KF-ADR-019f86da-4f90-7c76-bf49-3e804d3ba63f's semantic decision stands: `carrier_type=1000` is transport metadata,
...
outside the compatibility target, consistent with KF-ADR-019f86da-4f90-7c76-bf49-3e804d3ba63f.

## Relation to earlier ADRs

- **KF-ADR-019f86da-4f90-7a55-9b15-93fcab44a33a is superseded in schema scope.** Its `nanomsg` to `nng`
...
- **KF-ADR-019f86da-4f90-7bf2-9789-1b88bf3ed265 stands.** Its closed runtime layout baseline applies to the Hana
  POD substrate. Open `.fbs` surfaces have their own declared evolution
  contracts and registry entries.
- **KF-ADR-019f86da-4f90-7c76-bf49-3e804d3ba63f is amended in representation only.** Generic carrier and action
  vocabulary semantics stand; JSON wire authority is replaced by
  `ActionEnvelope.fbs`.
- **KF-ADR-019f86da-4f90-7828-9142-46f9bca4b0f5 stands and is generalized.** Its storage record classification,
  opaque-body rule, JSON edge rule, and Hana-to-SQLite path are instances of
  this system-wide decision.
- **KF-ADR-019f86da-4f90-7a66-b427-f4bcd638d8bc stands unchanged in purpose.** It governs safe FlatBuffers access,
