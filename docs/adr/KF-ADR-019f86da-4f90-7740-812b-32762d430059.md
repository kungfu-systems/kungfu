...
adr_id: KF-ADR-019f86da-4f90-7740-812b-32762d430059
decision_status: accepted
implementation_status: staged
implementation_prs: [https://github.com/kungfu-systems/kungfu/pull/1583]
qualification_refs: [crates/xinfa/boundary.contract.json, crates/xinfa/extraction-manifest.json, crates/xinfa/tooling/standalone-smoke.mjs, crates/trunk/Cargo.toml, crates/trunk/src/main.rs, framework/core/src/python/kungfu/cli/commands/xinfa.py, framework/release/component-distribution.contract.json, scripts/check-npm-package-registry.mjs]
...
# KF-ADR-019f86da-4f90-7740-812b-32762d430059: Xinfa is an independently governed Rust component linked into the Kungfu trunk

- Status: accepted; embedded implementation and independent component release
  delivery are stage-ready pending review, merge, and protected publication
- Date: 2026-07-20
...
- Supersedes: the independent-binary, independent-release, and zero-host
  qualification portions of [KF-ADR-019f86da-4f90-7ca2-8757-52f713bd3df8](KF-ADR-019f86da-4f90-7ca2-8757-52f713bd3df8.md)
- Preserves: Xinfa semantic authority and extraction-first discipline from
  KF-ADR-019f86da-4f90-7ca2-8757-52f713bd3df8, the single public executable from
  [KF-ADR-019f86da-4f90-710c-a3b6-5e0cb5a28ad0](KF-ADR-019f86da-4f90-710c-a3b6-5e0cb5a28ad0.md), and the
...
KF-ADR-019f86da-4f90-77c0-827b-fe1a3aa43e2b's separation rule applies here: semantic independence does not require
