...
implementation_prs: [https://github.com/kungfu-systems/kungfu/pull/1304, https://github.com/kungfu-systems/kungfu/pull/1310, https://github.com/kungfu-systems/kungfu/pull/1320, https://github.com/kungfu-systems/kungfu/pull/1321, https://github.com/kungfu-systems/kungfu/pull/1466]
qualification_refs: [framework/release/kungfu-trademark-public-use.contract.json, framework/release/kungfu-ungfu-release-evidence.schema.json, framework/release/kungfu-ungfu-release-evidence.candidate.json, crates/trunk/src/product_identity.rs, framework/core/src/python/kungfu/product_identity.py, framework/gui/src/main/product-identity.ts, product/scripts/cli-surface-qualification.mjs, scripts/prepare-ungfu-release-evidence.mjs, scripts/prepare-ungfu-release-evidence.test.mjs, scripts/check-trademark-public-use.mjs, scripts/check-trademark-public-use.test.mjs, docs/qualification/trademark-public-use.md]
