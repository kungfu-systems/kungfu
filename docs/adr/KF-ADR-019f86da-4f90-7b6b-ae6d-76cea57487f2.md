...
qualification_refs: [.buildchain/buildchain.toml, .github/actions/require-alpha-preflight/alpha-macos-overflow.mjs, .github/workflows/build.yml, .github/workflows/release-new-version.yml, .github/workflows/stable-candidate-patrol.yml, docs/qualification/alpha-release-latency.contract.json, docs/qualification/alpha-ruleset.contract.json, docs/qualification/stable-release-continuation.contract.json, docs/qualification/stable-ruleset.contract.json, docs/release-promotion-rehearsal.contract.json, framework/release/publication-control-plane.mjs, framework/release/publication-surfaces.json, scripts/adr-release-gate.test.mjs, scripts/alpha-macos-overflow.test.mjs, scripts/release-promotion-rehearsal.test.mjs, scripts/alpha-promotion-preflight.test.mjs, scripts/alpha-release-timeline.test.mjs, scripts/alpha-release-history.test.mjs, scripts/alpha-cache-evidence.test.mjs, scripts/alpha-ruleset.test.mjs, scripts/stable-candidate-patrol.test.mjs, scripts/release-publication-control-plane.test.mjs, scripts/source-acceptance.mjs]
...
confidence: high
evidence_grade: B
ai_provenance: GPT-5 via Codex on 2026-07-30; this update adds the source-bound, publish-none macOS overflow controller plus independently routed Linux, macOS, and Windows exact-label offline fallback as bounded implementation evidence; no claim is made about future runner capacity or publication qualification
