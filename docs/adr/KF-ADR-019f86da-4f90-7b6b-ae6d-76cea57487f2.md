...
confidence: high
evidence_grade: B
ai_provenance: GPT-5 via Codex on 2026-07-30; this update adds the source-bound, publish-none macOS overflow controller, exact-label offline fast path, and contract tests as bounded implementation evidence; no claim is made about future runner capacity or publication qualification
