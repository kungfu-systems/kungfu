...
qualification_refs: [.buildchain/buildchain.toml, docs/qualification/alpha-release-latency.contract.json, docs/qualification/alpha-ruleset.contract.json, framework/release/publication-control-plane.mjs, framework/release/publication-surfaces.json, scripts/adr-release-gate.test.mjs, scripts/release-promotion-rehearsal.test.mjs, scripts/alpha-promotion-preflight.test.mjs, scripts/alpha-release-timeline.test.mjs, scripts/alpha-release-history.test.mjs, scripts/alpha-cache-evidence.test.mjs, scripts/alpha-ruleset.test.mjs, scripts/release-publication-control-plane.test.mjs, scripts/source-acceptance.mjs]
