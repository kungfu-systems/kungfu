...
ai_provenance: GPT-5 via Codex on 2026-07-20; based on current Fact, Episode, Fact Library, Initiative, Profile, source-export, recovery-backup, installed verifier, and retained exact-artifact qualification authorities; stable v4 release admission, non-Darwin platforms, and the cross-minor support window remain unobserved
---
...
bundles preserve exact roots. Fact Library and Initiative bundles compose Episode
...
decode Initiative, Episode, Fact, Profile, source, or backup semantics.
...
the live source authorities and prevents Episode ADR or Initiative schema metadata
from drifting again.
