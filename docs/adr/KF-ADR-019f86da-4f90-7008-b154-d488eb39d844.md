...
qualification_refs: [framework/core/exit/kungfu-exit-bundle.contract.json, framework/core/src/python/kungfu/exit_verifier.py, tests/fixtures/exit-bundle-contract/cases.json, scripts/check-exit-bundle-contract.test.mjs, docs/guides/exit-and-version-compatibility.md, docs/qualification/evidence/exit-clean-runtime/520a61af87/report.json, docs/qualification/evidence/provider-migration-product/bb6f4a42c1/report.json]
