...
ai_provenance: GPT-5 via Codex on 2026-09-02 and 2026-09-03 added the source-boundary, canonical-JSON extraction, stable-entrypoint import-convergence, and publication-boundary implementation evidence from the user-authorized framework public-boundary Assignments; protected merge, exact protected-head qualification, and native Assignment seal for pull request 3691 are not yet claimed
---
...
3690 was then superseded when the protected base advanced across concurrent
generated projections. Pull request 3691 carries the corrected latest-base
successor head and is the authoritative delivery candidate for this boundary
stage.
