...
adr_id: KF-ADR-019f86da-4f90-738c-b372-e509976f69ff
...
# KF-ADR-019f86da-4f90-738c-b372-e509976f69ff: a first-class content-addressed store is a runtime fact-ledger primitive, with mutable KV and fleet topology kept as separate capabilities
...
- Subsystem: `libyijinjing` / `libkungfu` runtime storage service, the
  content-addressed payload store, the storage record family (KF-ADR-019f86da-4f90-7828-9142-46f9bca4b0f5), and the
  Python/Node storage bindings.
- Related: KF-ADR-019f86da-4f90-70c5-b572-89ec183b37de established the runtime storage service and its provider
  neutrality (content-addressed-file / rocksdb); KF-ADR-019f86da-4f90-76a1-8eda-6e49fa70e7d5 builds Git-like source
  sync on the native location/channel types; KF-ADR-019f86da-4f90-762d-a677-5e8984cc6692 makes the Episode manifest
  a yijinjing-native append-only journal; KF-ADR-019f86da-4f90-7e58-bb03-bee0f101dc01 fixes the workspace-local
  `.kungfu` home; KF-ADR-019f86da-4f90-7828-9142-46f9bca4b0f5 makes the storage record family Hana-core kernel
  metadata and payload bodies opaque content-addressed bytes; KF-ADR-019f86da-4f90-7d2c-aaa5-974ca5e38654 separates
  content hashes from frame checksums; the yijinjing single-writer-per-location
  publish contract (KF-ADR-019f86da-4f90-7179-a900-c40bdb498910) underlies the per-writer scaling model here.

## Context

The storage-record migration (KF-ADR-019f86da-4f90-7828-9142-46f9bca4b0f5) surfaced a requirement that is larger
...
- Payload bodies are already opaque content-addressed bytes (KF-ADR-019f86da-4f90-7828-9142-46f9bca4b0f5 point 6),
...
- The provider abstraction (KF-ADR-019f86da-4f90-70c5-b572-89ec183b37de: content-addressed-file / rocksdb) opens
...
- **Enforce it mechanically, not by prose.** Add a source-quality boundary gate
  (in the spirit of KF-ADR-019f86da-4f90-7a66-b427-f4bcd638d8bc's `check-view-boundary.mjs`) that fails if
...
- The content store becomes a stable substrate contract that outlives any one record type;
  the storage record family (KF-ADR-019f86da-4f90-7828-9142-46f9bca4b0f5) and the import-manifest migration build on
...
- RocksDB remains a candidate for the large-scale write-heavy envelope.
  The earlier suggestion (in the KF-ADR-019f86da-4f90-7828-9142-46f9bca4b0f5 discussion) to consider dropping it was
...
- A gc / retention / compaction policy becomes first-class at this scale
  (KF-ADR-019f86da-4f90-70c5-b572-89ec183b37de deferred destructive gc); this ADR sets the scale context that policy
...
- Add the boundary gate that fails if `libyijinjing` references RocksDB (or any
  concrete engine) by include, symbol, or link, in the spirit of KF-ADR-019f86da-4f90-7a66-b427-f4bcd638d8bc's
...
- Destructive gc / compact execution and the retention policy (KF-ADR-019f86da-4f90-70c5-b572-89ec183b37de); this
...
- **Store all manifest/record data as journal frames (append every entry).**
  ...
  a sealed object. (KF-ADR-019f86da-4f90-7828-9142-46f9bca4b0f5 point 3 "sealed roots are immutable" is consistent
  with this.)
...
- Retention at PB scale requires a real gc / tiering policy (KF-ADR-019f86da-4f90-70c5-b572-89ec183b37de deferred);
