...
| [0127](ADR-0127-xinfa-wasm-engine-and-native-minting-boundary.md) | accepted | Xinfa compiles one hash-pinned WebAssembly engine for development execution and receipt verification while the native trunk alone mints production receipts |
