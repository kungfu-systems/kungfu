...
implementation_prs: [https://github.com/kungfu-systems/kungfu/pull/980, https://github.com/kungfu-systems/kungfu/pull/1000, https://github.com/kungfu-systems/kungfu/pull/1002, https://github.com/kungfu-systems/kungfu/pull/1487, https://github.com/kungfu-systems/kungfu/pull/3467]
closure_pr: https://github.com/kungfu-systems/kungfu/pull/1002
qualification_refs: [framework/core/tests/python/test_assignment_review_equivalence.py, framework/core/tests/python/test_agent_console_contract.py, framework/core/tests/python/test_assignment_runtime.py, framework/core/tests/python/test_work_control_profile.py, extensions/work-dashboard/tests/work-control-profile.test.ts, framework/core/src/python/kungfu/agent/kfd3_api.registry.json, framework/work/evidence/schema/evidence-envelope-v1.schema.json, framework/work/evidence/src/evidence-envelope.mjs, scripts/check-evidence-envelope.test.mjs]
...
### 6. Status is an observational projection, not a writer lease

Pull request 3467 extends the same Work Control authority boundary to ordinary
status reads. The CLI and Agent status surface reuses the canonical Assignment
projection directly and does not enter the runtime writer or create a second
state fold. Claim, gate, review, continuation, and every mutating action retain
their existing writer and fence requirements; this change only removes an
unnecessary writer dependency from an observational path. The exact source
qualification, default-CLI installation check, and protected delivery Warrant
remain required before the pull request becomes retained implementation
evidence.
