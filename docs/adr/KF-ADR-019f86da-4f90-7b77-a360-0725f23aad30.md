...
qualification_refs: [framework/project-cut/composition.contract.json, framework/project-cut/src/composition.mjs, scripts/check-project-cut-composition.test.mjs, scripts/check-project-cut-composition-gate.mjs, docs/qualification/gates/dev-queue-admission.contract.json, scripts/dev-delivery-proof-consumer.test.mjs]
