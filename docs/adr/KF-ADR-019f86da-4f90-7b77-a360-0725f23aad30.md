...
implementation_prs: [https://github.com/kungfu-systems/kungfu/pull/1165, https://github.com/kungfu-systems/kungfu/pull/1171, https://github.com/kungfu-systems/kungfu/pull/1720, https://github.com/kungfu-systems/kungfu/pull/2458]
qualification_refs: [framework/work/project-cut/composition.contract.json, framework/work/project-cut/src/composition.mjs, scripts/check-project-cut-composition.test.mjs, scripts/check-project-cut-composition-gate.mjs, docs/qualification/gates/dev-queue-admission.contract.json, scripts/dev-delivery-proof-consumer.test.mjs]
...
- [PR #1720](https://github.com/kungfu-systems/kungfu/pull/1720) retains
  bounded replay conflicts as visible omissions only when an exact active
  successor Cut anchors the candidate output projection.
- [PR #2458](https://github.com/kungfu-systems/kungfu/pull/2458) projects a
  source-bound qualification proof from the immutable PR head, consumes the
  state-ref Warrant before GitHub queue admission, and records a distinct
  integration proof from the merge-group candidate. Latest-base replay keeps
  the PR head unchanged and fails closed when the classified base delta could
  affect the source proof.
