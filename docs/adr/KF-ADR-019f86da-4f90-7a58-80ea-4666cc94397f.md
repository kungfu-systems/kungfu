...
The terminology contract is: **The consumer project compiles a Xinfa Atlas**.
“consumer project” or “consumer repository” names the source/control-plane project;
...
`compatibility/context-pack-v1/`. source records the relationship as
