...
```json kungfu-evolution-stage
{
  ...
  "priorLimitation": "External mission records could describe intent, but the runtime lacked one portable, Project Cut-bound work object and assignment family.",
  ...
  "unlockedCapabilities": ["portable work continuation", "native assignment dependency graphs", "completion claims and independent review", "runtime-owned Mission projection"],
