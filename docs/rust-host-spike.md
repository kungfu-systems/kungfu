...
Status: spike complete; measured facts and a staged recommendation, no
commitment. The probe code lives in `crates/host-spike` (workspace-excluded,
never in CI or the release matrix). This report is the deliverable; the probe
is its evidence.
