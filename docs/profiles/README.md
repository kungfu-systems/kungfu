...
Profiles apply the domain-neutral Episode core to concrete agent-work and
application scenarios. They may define higher-level workflows, but they do not
redefine the core execution vocabulary.
