...
> **Compatibility classification:** retained Mission Control v3 design
> history. **Successor:** Work Control, `kungfu.work-control`. This page is
> excluded from current product discovery.
>
