...
> **Compatibility classification:** retained Mission Control v3 protocol and
> historical product evidence. **Successor:** Work Control,
> `kungfu.work-control`. This page is excluded from current product discovery.
>
...
1. **Mission Home** — the five-question workspace home: intent, material events,
   ...
   [Mission Control v3 Workspace Product Design](mission-control-v3-workspaces.md).
