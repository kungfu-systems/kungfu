...
zero-copy, …), see [`concepts.md`](implementation-concepts.md); for how the pieces are layered,
see [`architecture.md`](../architecture/overview.md); for specific decisions and their
...
maturity remain grounded in [`contracts.md`](../qualification/contracts.md) and
[`known-limits.md`](../qualification/known-limits.md).
...
[`architecture.md`](../architecture/overview.md). It stays sustainable only while the
