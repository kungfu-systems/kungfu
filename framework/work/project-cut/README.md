...
`framework/work/project-cut` is the build-free, content-addressed protocol layer that
...
[`../../spec/format/project-cut-canonical-json.mjs`](../../spec/format/project-cut-canonical-json.mjs)
