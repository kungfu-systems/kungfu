...
BOOST_HANA_ADAPT_STRUCT(kungfu::runtime::storage_service_api::storage_layout_paths_view, data_home, workspace_ignore,
                        workspace_config, extensions_dir, runtime_dir, dataset_dir, inbox_dir, backtest_dir,
                        sealed_episodes_dir, project_cuts_dir, journal_dir, db_dir, nn_dir, map_dir, log_dir,
                        ownership_dir, coordinator_dir, skill_manager_dir, agent_session_dir, skill_context_dir,
                        project_cut_runtime_dir, sources_dir, peers_dir, coordination_dir, admission_dir,
                        fact_durable_admission_dir, receipts_dir, legacy_master_dir, storage_dir,
