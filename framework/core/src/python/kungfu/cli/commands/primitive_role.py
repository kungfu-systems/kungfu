...
def role_capabilities(role: str) -> dict:
    ...
    return {
        ...
        "actionGeometryRoot": profile["actionGeometryRoot"],
        "domainProfileRoot": profile["domainProfileRoot"],
        "roleSchemaRoot": profile["roleSchemaRoots"][role],
        "roleBodySchema": profile["roleBodySchemas"][role],
