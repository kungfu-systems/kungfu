...
| `libkungfu-contracts` | `ports-contracts` | `core/runtime-contracts` | 66 | `yijinjing`<br>`kungfu_contracts`<br>`kungfu` | `kungfu_runtime_error_tests`<br>`kungfu_durability_contract_tests` | `src/libkungfu/include/kungfu/runtime/common.h`<br>`src/libkungfu/include/kungfu/runtime/storage/service.h` |
...
| `kungfu_storage_services` | `OBJECT` | `runtime-storage-services` | `kungfu_contracts` | 23 |
| `kungfu_extension_services` | `OBJECT` | `runtime-extension-services` | `kungfu_contracts` | 11 |
