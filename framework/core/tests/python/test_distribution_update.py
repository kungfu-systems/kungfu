...
from kungfu import distribution_update, release_cut, runtime_upgrade  # noqa: E402
...
def _manifest(
    ...
    *,
    ...
    return {
        ...
        "sourceCommit": "1" * 40,
        "runtimeBuildId": f"runtime-{build_id or product_version}-fixture",
        "runtimeArtifactDigest": digest,
        "runtimeEntrypoint": "kungfu",
        "frontendBuildId": f"product-{build_id or product_version}-fixture",
